...
<html>
            ...
            function initNote(desc, lon, lat, alt,id,rem){
                ...
                if(rem == true){
                    google.maps.event.addListener(marqueurToPush, 'rightclick', (function(marqueurToPush,currentNote){
                        return function(){
                            var val = prompt("Modifiez la description votre note",contentInfo[currentNote][1]);
                            $.post("/GeoNotesClient/servlet/updateNote",{id:contentInfo[currentNote][4], desc:val},function(data){contentInfo[currentNote][1] = val});
                        }
                    })(marqueurToPush,currentNote));
                }
                currentNote++;
                        ...
                        if (results[0]) {                                    
                            ...
                            if(titre != null){
                                ...
                                $.post("/GeoNotesClient/servlet/ajoutNote",{longitude : longitudeNote, latitude : latitudeNote, altitude : altitude, description : titre},function(data){
                                    ...
                                    google.maps.event.addListener(marqueurToPush, 'rightclick', (function(marqueurToPush,currentNote){
                                        return function(){
                                            var val = ("Modifiez la description votre note",contentInfo[currentNote][1]);
                                            $.post("/GeoNotesClient/servlet/updateNote",{id:contentInfo[currentNote][4], desc:val},function(data){marqueurToPush.setMap(null);
                                                currentNote--;});
                                        }
                                    })(marqueurToPush,currentNote));
                                    currentNote++;
    ...
    <body onload="initialise()">        
        ...
        <div id="titre" class ="lightbox"><h2>Modification de notes</h2></div>
        ...
        <div id="legende" class="lightBox">
            ...
            <ul>
                ...
                <li>clic droit : modifier les informations</li>
            </ul>
        </div>
    </body>
</html>
